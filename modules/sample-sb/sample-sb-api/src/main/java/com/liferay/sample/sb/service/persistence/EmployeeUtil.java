...
public class EmployeeUtil {
	...
	public static Employee findByUuid_First(
		...
		throws com.liferay.sample.sb.exception.NoSuchEmployeeException {
	 ...
	 * @throws NoSuchEmployeeException if a matching employee could not be found
	 */
	public static Employee findByEmployeeEmail(String employeeEmail)
		throws com.liferay.sample.sb.exception.NoSuchEmployeeException {

		return getPersistence().findByEmployeeEmail(employeeEmail);
	}
	 ...
	 */
	@Deprecated
	public static Employee fetchByEmployeeEmail(
		String employeeEmail, boolean useFinderCache) {

		return getPersistence().fetchByEmployeeEmail(
			employeeEmail, useFinderCache);
	}
	 ...
	 * @return the matching employee, or <code>null</code> if a matching employee could not be found
	 */
	public static Employee fetchByEmployeeEmail(String employeeEmail) {
		return getPersistence().fetchByEmployeeEmail(employeeEmail);
	}
	 ...
	 * @return the employee that was removed
	 */
	public static Employee removeByEmployeeEmail(String employeeEmail)
		throws com.liferay.sample.sb.exception.NoSuchEmployeeException {

		return getPersistence().removeByEmployeeEmail(employeeEmail);
	}
	 ...
	 * @return the number of matching employees
	 */
	public static int countByEmployeeEmail(String employeeEmail) {
		return getPersistence().countByEmployeeEmail(employeeEmail);
	}
